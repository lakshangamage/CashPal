...
public class eceivePaymentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eceive_payment);
        init_Ui();
        setText();
    }
    ...
    public void setText() {
        titleText.setText(Strings.getReceivePaymentButtonText());
