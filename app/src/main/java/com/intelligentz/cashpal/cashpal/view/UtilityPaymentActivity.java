...
public class UtilityPaymentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void setText() {
        titleText.setText(Strings.getUtilityPaymentButtonText());
        spinner.setPrompt(Strings.getUtilityTypeText());
