...
public class InstitutionalPaymentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_institutional_payment);
        init_Ui();
        setText();
    }
    ...
    public void setText() {
        titleText.setText(Strings.getInstitutionalPaymentButtonText());
        spinner.setPrompt(Strings.getInstitutionText());
